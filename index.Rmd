...
#if you want to re-tidy the bib run this - but beware
  #recompile doc and make sure everything gets cited though. Kinda dangerzone to run
if(FALSE){
  library(citr)
