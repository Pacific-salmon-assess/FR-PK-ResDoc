---
title: |
    "Quantifying Wild Salmon Policy biological benchmarks and assessing biological and fishery consequences of current harvest control rule for Fraser River Pink Salmon (*Oncorhynchus gorbuscha*)"
...
options(scipen = 1, digits = 2) #tried tinytex.verbose = TRUE to make prior table work
