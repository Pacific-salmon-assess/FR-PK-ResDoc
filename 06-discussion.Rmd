...
We estimated the Upper Stock Reference Point of 80% $S_{MSY}$ to be `r benchmarks[2,1]`m (`r benchmarks[2,2]`m - `r benchmarks[1,3]`m), and the Limit Reference Point $S_{gen}$ to be `r benchmarks[1,1]`m (`r benchmarks[1,2]`m-`r benchmarks[1,3]`m). 
...
We found that the existing HCR for Fraser Pinks has a very low probability (< 0.02) of the stock falling below the Limit Reference Point, and a relatively high probability (>0.70) of spawner abundance being above the Upper Stock Reference Point, over the next 10 years. **review**
