...
We found that the existing HCR for Fraser Pinks has a very low probability (< 0.02) of the stock falling below the Limit Reference Point, and a relatively high probability (>0.70) of spawner abundance being above the uUpper Stock Referene Point, over the next 10 years. 
...
The two robustness tests of the current HCR suggest that if stock productivity were to decline sharply and/or be depressed for a prolonged period the current HCR may have an unacceptably high probability of the stock falling below the lLimit Reference Point and hence being at risk of serious and irreversible biological harm.  
...
The price of Pink Salmon has been so low in recent years that it may not be economically feasible for commercial fishers to operate. 
