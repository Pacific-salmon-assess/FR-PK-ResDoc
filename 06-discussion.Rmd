...
We found that the existing HCR for Fraser Pinks has a very low probability (< 0.02) of the stock falling below the Limit Reference Point, and a relatively high probability (>0.70) of spawner abundance being above the Upper Stock Reference Point, over the next 10 years. 
