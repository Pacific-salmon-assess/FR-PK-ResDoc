...
We estimated the Upper Stock Reference Point of 80% $S_{MSY}$ to be `r benchmarks[1,1]`m (`r benchmarks[1,2]`m - `r benchmarks[1,3]`m), and the Limit Reference Point $S_{gen}$ to be `r benchmarks[2,1]`m (`r benchmarks[2,2]`m-`r benchmarks[2,3]`m). 
