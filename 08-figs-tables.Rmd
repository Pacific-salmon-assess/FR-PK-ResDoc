...
(ref:fig-map) Fraser River Basin, extent of Pink salmon spawning distribution (red), and approximate locations of the Mission hydroacoustics site, Hell's Gate and Big Bar. Map adapted from [@grantFraserRiverPink2014].  
...
(ref:tab-priors) Prior probability distributions for parameters. ***Note - unsure how to provide hyperlink to reference for transformation of Smax prior***.
