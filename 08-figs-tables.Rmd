...
(ref:perf-metrics-descriptions) Descriptions of metrics assessed in the forward simulations of harvest control rules. 
```{r perf-metrics-descriptions, results = "asis"}
#df <- data.frame(Metric = c("% sims < S_{gen}", "% sims > S_{MSY}"), 
#                 Description = )
```

(ref:prior-posterior-table) Parameters, priors, descriptions, and posteriors from the spawner-recruit model. 
```{r prior-posterior-table, results = "asis}
