...
(ref:current-HCR) Current harvest control rule showing target escapement (top) and exploitation rate (bottom) for Fraser Pinks.  
```{r current-HCR, fig.cap = "(ref:current-HCR)"}
knitr::include_graphics(here::here("figure/current-HCR.png"))
```
