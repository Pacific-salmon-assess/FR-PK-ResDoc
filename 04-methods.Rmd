...
Some analyses on Fraser Pinks have been cautious to use data that enumerated escapement with different methods. 
To address this, we truncated the data to only be 1993 to present and refit the model, then used parameters estimated from that data in the forward simulation, under the same harvest control rules used in the other simulations.  
