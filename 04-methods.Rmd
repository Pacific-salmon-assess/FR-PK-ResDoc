...
It is this spawner abundance $S_y$ that is used in *eqn ref* to produce the recruitment abundance produced by spawning in brood year $y$.
...
When looking at target escapement (Figure \@ref(fig:fig-HCRs)) there is a slight hump where target escapment ascends from 0 to approximately 5 million spawners, but then slightly descends to $R_{S_{MSY}}$. 
