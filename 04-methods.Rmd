...
We then derived estimates of biological benchmarks to assess stock status. 
...
The values used for these biological benchmarks were based on the joint posterior distributions of estimated parameters in each iteration of the simulation thereby ensuring that uncertainty was explicitly accounted for in the performance measure calculations. 

Fishery objectives included maximizing average harvest and inter-annual stability in harvest, and minimizing the probability harvests fall below a minimum catch index level which, for illustrative purposes, was chosen as the mean catch of the highest three catches since the year 2000 (i.e. an indicator of a "good" fishing year).  
