...
This obligate 2 year life cycle exhibited by Pink salmon results in even and odd year cohorts that are reproductively isolated from each other and density-dependent interactions between odd and even lineages likely often contributes to one cycle line being numerically dominant over the other (**cite Krkosek et al. 20111 doi: 10.1098/rspb.2010.2335**). The even year Pink return to the Fraser is negligible (***not fished?, unobservable?***).    


Detailed studies of the marine distribution of Fraser River Pink salmon are lacking but fisheries data provide some insight. 
...
This diversion rate is increasingly dominated by northern migration route, which affects the accuracy of run size estimates [@hagueMovingTargetsAssessing2021] through differential encounters with test fisheries. 
