...
Table \@ref(tab:spawner-est-methods) Describes the different enumeration stanzas through time. 
...
In the last three generations, the run size and escapement have been stable, with a slight increase, with an average run size of 9.2 million, average escapement of 8.6 million, and an average ER of 6%. 
